...
- barra de progreso del ledger siempre visible en la seccion Run (`done/processing/error/pending`)
- presets de prompt por modelo en la GUI (Gemini: `Book Balanced`, `Lovecraft Tone`, `Technical Manual`, `Polish Copyedit`)
